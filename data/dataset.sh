...
tar -zvxf v1.0-trainval01_blobs.tgz -C ./nuscenes
...
tar -zvxf v1.0-trainval02_blobs.tgz -C ./nuscenes
...
tar -zvxf v1.0-trainval03_blobs.tgz -C ./nuscenes
...
tar -zvxf v1.0-trainval04_blobs.tgz -C ./nuscenes
...
tar -zvxf v1.0-trainval05_blobs.tgz -C ./nuscenes
...
tar -zvxf v1.0-trainval06_blobs.tgz -C ./nuscenes
...
tar -zvxf v1.0-trainval07_blobs.tgz -C ./nuscenes
...
tar -zvxf v1.0-trainval08_blobs.tgz -C ./nuscenes
...
tar -zvxf v1.0-trainval09_blobs.tgz -C ./nuscenes
...
tar -zvxf v1.0-trainval10_blobs.tgz -C ./nuscenes
